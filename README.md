...
# OwlEyes
 ...
 > Last Updated 10/08/2023 01:17:56 UTC+5 (Asia/Ashgabat)
...
# IBM-X-FORCE-EXCHANGE
 ...
 |[Intel VCUST Tool software privilege escalation (CVE-2023-25944)](https://exchange.xforce.ibmcloud.com/activity/list?filter=Vulnerabilities)|Visit link for details|Aug 8, 2023|
 |[Intel Virtual RAID on CPU (VROC) software privilege escalation (CVE-2022-45112)](https://exchange.xforce.ibmcloud.com/activity/list?filter=Vulnerabilities)|Visit link for details|Aug 8, 2023|
 |[Intel Advanced Link Analyzer Standard Edition software privilege escalation (CVE-2023-27505)](https://exchange.xforce.ibmcloud.com/activity/list?filter=Vulnerabilities)|Visit link for details|Aug 8, 2023|
 |[Intel Implicit SPMD Program Compiler (ISPC) software privilege escalation (CVE-2023-27509)](https://exchange.xforce.ibmcloud.com/activity/list?filter=Vulnerabilities)|Visit link for details|Aug 8, 2023|
