...
# OwlEyes
 ...
 > Last Updated 05/08/2023 21:19:13 UTC+5 (Asia/Ashgabat)
...
# IBM-X-FORCE-EXCHANGE
 ...
 |[Cloudflare odoh-rs denial of service (CVE-2023-3766)](https://exchange.xforce.ibmcloud.com/activity/list?filter=Vulnerabilities)|Visit link for details|Aug 3, 2023|
 |[HCL Unica Platform privilege escalation (CVE-2023-37498)](https://exchange.xforce.ibmcloud.com/activity/list?filter=Vulnerabilities)|Visit link for details|Aug 3, 2023|
 |[Smackcoders WP Ultimate CSV Importer plugin for WordPress code execution (CVE-2023-4142)](https://exchange.xforce.ibmcloud.com/activity/list?filter=Vulnerabilities)|Visit link for details|Aug 3, 2023|
 |[Smackcoders WP Ultimate CSV Importer plugin for WordPress code execution (CVE-2023-4141)](https://exchange.xforce.ibmcloud.com/activity/list?filter=Vulnerabilities)|Visit link for details|Aug 3, 2023|
