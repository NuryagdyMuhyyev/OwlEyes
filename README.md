...
# OwlEyes
 ...
 > Last Updated 30/08/2024 08:21:32 UTC+5 (Asia/Ashgabat)
...
# HK-CERT
 ...
 |[Google Chrome Multiple Vulnerabilities](https://www.hkcert.org/security-bulletin/google-chrome-multiple-vulnerabilities_20240829)|Multiple vulnerabilities were identified in Google Chrome. A remote attacker could exploit some of these vulnerabilities to trigger denial of service condition and remote code execution on the targeted system.|Release Date: 29 Aug 2024 |
...
# IBM-X-FORCE-EXCHANGE
 ...
 |Title|Description|Date|
 |---|---|---|
 |[Delta Electronics DTN Soft code execution (CVE-2024-8255)](https://exchange.xforce.ibmcloud.com/activity/list?filter=Vulnerabilities)|Visit link for details|Aug 29, 2024|
 |[Menulux Managment Portal security bypass (CVE-2024-4428)](https://exchange.xforce.ibmcloud.com/activity/list?filter=Vulnerabilities)|Visit link for details|Aug 29, 2024|
 |[Dell PowerEdge Server information disclosure (CVE-2024-38304)](https://exchange.xforce.ibmcloud.com/activity/list?filter=Vulnerabilities)|Visit link for details|Aug 29, 2024|
 ...
 |[Progress Software WhatsUp Gold SQL injection (CVE-2024-6671)](https://exchange.xforce.ibmcloud.com/activity/list?filter=Vulnerabilities)|Visit link for details|Aug 28, 2024|
