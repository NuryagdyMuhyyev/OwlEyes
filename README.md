...
# OwlEyes
 ...
 > Last Updated 09/08/2023 00:13:34 UTC+5 (Asia/Ashgabat)
...
# OBS-Vigilance
 ...
 |Title|Description|Date|
 |---|---|---|
 |[<a href="https://vigilance.fr/vulnerability/Dompdf-three-vulnerabilities-41959" class="noirorange"><b>Dompdf</b>: three vulnerabilities</a>](https://vigilance.fr/vulnerability/Dompdf-three-vulnerabilities-41959)|An attacker can use several vulnerabilities of Dompdf...|Visit link for details|
 |[<a href="https://vigilance.fr/vulnerability/Cisco-AnyConnect-Secure-Mobility-Client-Secure-Client-information-disclosure-via-VPN-Client-Traffic-Leak-41958" class="noirorange"><b>Cisco AnyConnect Secure Mobility Client  Secure Client</b>: information disclosure via VPN Client Traffic Leak</a>](https://vigilance.fr/vulnerability/Cisco-AnyConnect-Secure-Mobility-Client-Secure-Client-information-disclosure-via-VPN-Client-Traffic-Leak-41958)|An attacker can bypass access restrictions to data of Cisco AnyConnect Secure Mobility Client  Secure Client, via VPN Client Traffic Leak, in order to read sensitive information...|Visit link for details|
...
# IBM-X-FORCE-EXCHANGE
 ...
 |Title|Description|Date|
 |---|---|---|
 |[Adobe XMP-Toolkit-SDK denial of service (CVE-2023-38210)](https://exchange.xforce.ibmcloud.com/activity/list?filter=Vulnerabilities)|Visit link for details|Aug 8, 2023|
 |[Siemens Tecnomatix Plant Simulation code execution (CVE-2023-38679)](https://exchange.xforce.ibmcloud.com/activity/list?filter=Vulnerabilities)|Visit link for details|Aug 8, 2023|
 |[Siemens Solid Edge code execution (CVE-2023-39181)](https://exchange.xforce.ibmcloud.com/activity/list?filter=Vulnerabilities)|Visit link for details|Aug 8, 2023|
 |[Siemens Solid Edge code execution (CVE-2023-39182)](https://exchange.xforce.ibmcloud.com/activity/list?filter=Vulnerabilities)|Visit link for details|Aug 8, 2023|
 |[Siemens Solid Edge code execution (CVE-2023-39183)](https://exchange.xforce.ibmcloud.com/activity/list?filter=Vulnerabilities)|Visit link for details|Aug 8, 2023|
 |[Siemens Solid Edge code execution (CVE-2023-39184)](https://exchange.xforce.ibmcloud.com/activity/list?filter=Vulnerabilities)|Visit link for details|Aug 8, 2023|
 |[Siemens Solid Edge code execution (CVE-2023-39185)](https://exchange.xforce.ibmcloud.com/activity/list?filter=Vulnerabilities)|Visit link for details|Aug 8, 2023|
