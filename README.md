...
# OwlEyes
 ...
 > Last Updated 15/11/2023 08:17:44 UTC+5 (Asia/Ashgabat)
...
# IBM-X-FORCE-EXCHANGE
 ...
 |Title|Description|Date|
 |---|---|---|
 |[Microsoft Windows Protected Extensible Authentication Protocol (PEAP) code execution (CVE-2023-36028)](https://exchange.xforce.ibmcloud.com/activity/list?filter=Vulnerabilities)|Visit link for details|Nov 14, 2023|
 |[Microsoft Windows SmartScreen security bypass (CVE-2023-36025)](https://exchange.xforce.ibmcloud.com/activity/list?filter=Vulnerabilities)|Visit link for details|Nov 14, 2023|
 |[Microsoft Visual Studio Code Jupyter Extension spoofing (CVE-2023-36018)](https://exchange.xforce.ibmcloud.com/activity/list?filter=Vulnerabilities)|Visit link for details|Nov 14, 2023|
 |[Microsoft Windows Scripting Engine code execution (CVE-2023-36017)](https://exchange.xforce.ibmcloud.com/activity/list?filter=Vulnerabilities)|Visit link for details|Nov 14, 2023|
 |[Microsoft Dynamics 365 (on-premises) cross-site scripting (CVE-2023-36016)](https://exchange.xforce.ibmcloud.com/activity/list?filter=Vulnerabilities)|Visit link for details|Nov 14, 2023|
