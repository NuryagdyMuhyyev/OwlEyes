...
# OwlEyes
 ...
 > Last Updated 23/10/2023 09:20:21 UTC+5 (Asia/Ashgabat)
...
# IBM-X-FORCE-EXCHANGE
 ...
 |[flowpaper plugin for WordPress cross-site scripting (CVE-2023-5200)](https://exchange.xforce.ibmcloud.com/activity/list?filter=Vulnerabilities)|Visit link for details|Oct 20, 2023|
 |[Magic Action Box plugin for WordPress cross-site scripting (CVE-2023-5231)](https://exchange.xforce.ibmcloud.com/activity/list?filter=Vulnerabilities)|Visit link for details|Oct 20, 2023|
 |[Advanced Custom Fields: Extended plugin for WordPress cross-site scripting (CVE-2023-5292)](https://exchange.xforce.ibmcloud.com/activity/list?filter=Vulnerabilities)|Visit link for details|Oct 20, 2023|
 |[Podcast Subscribe Buttons plugin for WordPress cross-site scripting (CVE-2023-5308)](https://exchange.xforce.ibmcloud.com/activity/list?filter=Vulnerabilities)|Visit link for details|Oct 20, 2023|
 |[Contact form Form For All plugin for WordPress cross-site scripting (CVE-2023-5337)](https://exchange.xforce.ibmcloud.com/activity/list?filter=Vulnerabilities)|Visit link for details|Oct 20, 2023|
