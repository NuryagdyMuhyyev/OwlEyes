...
# OwlEyes
 ...
 > Last Updated 26/06/2024 07:33:44 UTC+5 (Asia/Ashgabat)
...
# IBM-X-FORCE-EXCHANGE
 ...
 |[Google Chrome code execution (CVE-2024-6293)](https://exchange.xforce.ibmcloud.com/activity/list?filter=Vulnerabilities)|Visit link for details|Jun 24, 2024|
 |[Google Chrome code execution (CVE-2024-6292)](https://exchange.xforce.ibmcloud.com/activity/list?filter=Vulnerabilities)|Visit link for details|Jun 24, 2024|
 |[Google Chrome code execution (CVE-2024-6291)](https://exchange.xforce.ibmcloud.com/activity/list?filter=Vulnerabilities)|Visit link for details|Jun 24, 2024|
 |[Google Chrome code execution (CVE-2024-6290)](https://exchange.xforce.ibmcloud.com/activity/list?filter=Vulnerabilities)|Visit link for details|Jun 24, 2024|
