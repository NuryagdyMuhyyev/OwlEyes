...
CYBEROWL_SOURCES = [
    ...
    [
        ...
        "The French national government Computer Security Incident Response Team.",
    ],
    [
        "[IBM X-Force Exchange](#ibmcloud-arrow_heading_up)",
        "A cloud-based threat intelligence platform that allows to consume, "
        "share and act on threat intelligence.",
    ],
    [
        "[ZeroDayInitiative](#zerodayinitiative-arrow_heading_up)",
        "An international software vulnerability initiative that was started"
        " in 2005 by TippingPoint.",
    ],
    [
        "[OBS Vigilance](#obs-vigilance-arrow_heading_up)",
        "Vigilance is an initiative created by OBS (Orange Business Services) "
        "since 1999 to watch public vulnerabilities and then offer security fixes,"
        " a database and tools to remediate them.",
    ],
    [
        "[VulDB](#vuldb-arrow_heading_up)",
